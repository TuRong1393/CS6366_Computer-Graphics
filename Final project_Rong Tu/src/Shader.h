...
public:
	...
	void del() { glDeleteProgram(this->program); }
	...
	{
		glUniform1i(glGetUniformLocation(this->program, varName), (int)b);
	}
	void setMatrix4fv(const GLchar *varName, GLsizei count, GLboolean transpose, const GLfloat *value)
	{
		glUniformMatrix4fv(glGetUniformLocation(this->program, varName), count, transpose, value);
	}
	void setVec3(const GLchar *varName, GLfloat v0, GLfloat v1, GLfloat v2)
	{
		glUniform3f(glGetUniformLocation(this->program, varName), v0, v1, v2);
	}
	void setVec3(const GLchar *varName, GLsizei count, const GLfloat *value)
	{
		glUniform3fv(glGetUniformLocation(this->program, varName), count, value);
	}
	void setVec4(const GLchar *varName, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3)
	{
		glUniform4f(glGetUniformLocation(this->program, varName), v0, v1, v2, v3);
	}
	void setVec1(const GLchar *varName, GLfloat v0)
	{
		glUniform1f(glGetUniformLocation(this->program, varName), v0);
	}
